...
echo "<script>window.location.href ='manage-notices-teacher.php'</script>";
...
<td>
<a href="manage-notices-teacher.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete the notice?');" class="btn btn-danger">
