...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination-teacher.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to ativate this subject');" class="btn btn-success"><i class="fa fa-check" title="Acticvate Record"></i> </a><?php } else {?>

<a href="manage-subjectcombination-teacher.php?did=<?php echo htmlentities($result->scid);?>"  class="btn btn-danger" onclick="confirm('do you really want to deativate this subject');"><i class="fa fa-times" title="Deactivate Record"></i> </a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
