...
<html lang="en">
    <head>
        ...
        <title>ResultPro||Dashboard</title>
                    ...
                    <div class="row">
                        <div class="navbar-header no-padding">
                			<a class="navbar-brand" target="a_blank" href="#">
                			    <img src="assets/images/logo1.png" style="Width: 190px">
                			</a>
                		...
                		<div class="collapse navbar-collapse" id="navbar-collapse-1">
                			<ul class="nav navbar-nav" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                ...
                                <li style="color: green;"><marquee behavior="scroll" scrollamount="3"><strong>BIT GROUP PROJECT E2145211(Front-End) Created</strong></marquee></li>
                			</ul>
                            <!-- /.nav navbar-nav -->
                			...
                			<ul class="nav navbar-nav navbar-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                             ...
                             <li><div id="google_translate_element"></div>
                				    ...
                				    <li>
                                    <a href="teacher-login.php" class="color-danger text-center"><i class="fa fa-sign-out"></i> Logout</a></li>
