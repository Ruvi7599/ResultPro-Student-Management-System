...
<td>
    <a href="delete-subject.php?subjectid=<?php echo htmlentities($result->id);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this subject?');"><i class="fa fa-trash" title="Delete Record"></i> </a> 
</td>
