                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center">
                                        <a class="dashboard-stat bg-white" href="manage-students-teacher.php">
<?php 
...
<span class="bg-icon"><i class="fa fa-users"></i></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center" >
                                        <a class="dashboard-stat bg-white" href="manage-subjects-teacher.php">
<?php 
...
?>
 <span class="bg-icon"><i class="fa fa-ticket"></i></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-center">
                                        <a class="dashboard-stat bg-white" href="manage-results-teacher.php">
                                        <?php 
