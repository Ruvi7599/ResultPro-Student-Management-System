            ...
            <div class="login-bg-color">
                <div class="row">
                    <div class="col-md-4 col-md-offset-7">
                        <div class="panel login-box" style="    background: #8f0047;">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <a href="#">
                    <img style="height: 70px" src="assets/images/footer-logo.png"></a>
                                    <h3 class="text-white">Advance Student Result Management System</h3>
                                </div>
                            </div>
...
<?php }} ?>
									...
									<div class="form-group mt-20">                                                                                                         
								<button type="submit" class="btn" style="color: #172541;">
									<a href="student-register.php" class="text-black">Register as a Student</a>
								</button>                                                                                 
                                    </div>
