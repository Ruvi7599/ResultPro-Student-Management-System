...
<br><div class="container">
        <div class="panel-title">
                                                    <h5><strong></h5>Keshan is</strong></h5>
                             <span style="background-color: #0b2a97;
    padding: 2px 10px;    
    color: #fff;">This is a group project for Moratuwa BIT</span><br>

    
                                                </div>
        <div class=" row col-md-5"><br><img src="https://miro.medium.com/max/1400/0*K2WLMTExLyida7OR.gif" style="height: 300px;"></img></div>
        <div class=" row col-md-4"><label for="success" class="control-label"><br></label>Owned by Keshan,Ruvinda and Sithumini </label><label style="background-color: #ffd600;
    padding: 0.2em; font-size: 14px;"></label></div>
    </div>
...
<br>
                                                        <div class="">
                                                            <a href="https://www.teamscorpian.com/" target="_blank">
