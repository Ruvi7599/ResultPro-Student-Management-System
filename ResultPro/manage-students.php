...
<td>
    <a href="delete-student.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this student?');"><i class="fa fa-trash" title="Delete Record"></i> </a> 
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
