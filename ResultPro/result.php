...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" href="styleofall.css" media="screen" >
        ...
        body {
            ...
            color: #333; /* Change font color if needed */
        }
        table {
            width: 100%;
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">ResultPro || Student-Result Management System</h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Result-Details</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
<td colspan="3" align="center"><i class="fa fa-print fa-2x" aria-hidden="true" style="cursor:pointer" OnClick="CallPrint(this.value)" ></i></td>
 ...
 <?php } else { ?>     
    <div class="alert alert-warning left-icon-alert" role="alert" style="color: #856404; background-color: #fff3cd; padding: 15px; border-radius: 5px; font-weight: bold;">
...
<div class="alert alert-danger left-icon-alert" role="alert" style="color: white; background-color: red; padding: 15px; border-radius: 5px; font-weight: bold;">
...
?>
    ...
    <a href="find-result.php">
        <button style="background-color: purple; color: white; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 4px;">
            Back to Student Area
                                                    ...
                                                    <!-- <div class="col-lg-5 text-lg-end">
                                                      <a href="find-result.php" class="btn btn-style btn-danger mt-lg-0 mt-md-5 mt-4">Back to Student Area</a>
                                                    </div> -->
