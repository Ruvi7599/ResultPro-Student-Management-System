                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="teacher-dash.php"><i class="fa fa-home"></i> Home</a></li>
                                        <li> Students</li>
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="edit-student-teacher.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-info"><i class="fa fa-edit" title="Edit Record"></i> </a> 

</td>
<td>
    <a href="delete-student-teacher.php?stid=<?php echo htmlentities($result->StudentId);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this student?');"><i class="fa fa-trash" title="Delete Record"></i> </a> 
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
